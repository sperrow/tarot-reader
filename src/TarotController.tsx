...
function TarotController() {
    ...
    const readButtonClasses = `w-full text-white bg-gradient-to-br from-yellow-600 to-purple-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-8 ${
        hideReadButton ? 'invisible' : ''
    }`;
    const hideBackButton = step !== 1;
    const backButtonClasses = `text-white bg-gray-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-4 py-2 text-center mb-8 ${
    ...
    const handleStart = async (cards: Card[]) => {
        ...
        // const res = await read(cardNames);
        // if (res) {
        //     setLoading(false);
    ...
    const currentStep =
        step === 0 ? (
            <div>
                <h2 className="mb-8">On what subject do you seek advice or knowledge?</h2>
                <ul>
                    <li>
                        <button
                            type="button"
            ...
            <div>
                <h2 className="mb-16">Select three cards</h2>
